...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Creating Obstacles
        img_obstacle1 = Image.open("images/obstacle1.png")
        ...
        # Create the Robot1
        img_robot1 = Image.open("images/robot1.png")
        self.robot1 = ImageTk.PhotoImage(img_robot1)
        self.agent = self.canvas.create_image(pixels * 0.5, pixels * 0.5, anchor='center', image=self.robot1)
